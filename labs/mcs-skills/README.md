...
1. Select the chevron beside **Publish** and choose **Customize publish channels** to open the
    **Publish agent** dialog. (Selecting the plain **Publish** button re-publishes the agent
    directly, without offering channel options.)
...
1. Let the run finish - it takes several minutes. Cowork drafts the proposal,
    uses the tools available to it to render it as a PDF, and publishes both files. They appear under
